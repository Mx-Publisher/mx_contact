...
|
|	additional credit	: Original "Contact Form" Mod by
|						  marcus.smith < marcus@phobbia.net > (MarcuS) http://www.phobbia.net/mods/
|	MOD Author			: darkassasin93 < N/A > (Matt Bowen) N/A
|
|	description			: Allows visitors to contact the site Admin via a Contact Form.
|						  Files can also be attached and sent if permitted
|   ScreenShot			: http://img146.imageshack.us/img146/2414/mxbbcontactxl1.png
|********************************************************************************|
|
|   @package mxBB Portal Module - mx_contact
|   @version $Id: readme.txt,v 1.2 2008/06/03 20:09:47 jonohlsson Exp $
